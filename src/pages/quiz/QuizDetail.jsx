...
const QuizDetail = () => {
  ...
  // return (
  //   // <div className="min-h-screen bg-gradient-to-b from-primary-100 to-primary-400">
  //   <div className="min-h-screen bg-gradient-to-br from-orange-50 via-white to-orange-100 py-10s">
  ...
  //       {/* Main Content */}
  //       {/* <div className="bg-white rounded-xl shadow-md border border-gray-100 overflow-hidden"> */}
  //       <div className=" bg-gradient-to-b from-primary-100 to-primary-400 rounded-2xl shadow-xl border border-gray-100">
