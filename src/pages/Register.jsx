                    ...
                    <div className="space-y-4">
                        ...
                        <div className="relative">
                            ...
                            <input
                                ...
                                autoComplete="new-password"
                                className={`block w-full pl-10 pr-10 py-2 bg-transparent border-0 border-b ${fieldErrors.password ? "border-red-400" : "border-gray-400"
                                    } placeholder-gray-700 text-gray-800 text-sm focus:outline-none focus:border-primary-600 focus:ring-0 transition-colors`}
                                placeholder="Password"
                                value={password}
                                onChange={onChange}
                            />
                        ...
                        <div className="relative">
                            ...
                            <input
                                ...
                                autoComplete="new-password"
                                className={`block w-full pl-10 pr-10 py-2 bg-transparent border-0 border-b ${fieldErrors.confirmPassword ? "border-red-400" : "border-gray-400"
                                    } placeholder-gray-700 text-gray-800 text-sm focus:outline-none focus:border-primary-600 focus:ring-0 transition-colors`}
                                placeholder="Confirm Password"
                                value={confirmPassword}
                                onChange={onChange}
